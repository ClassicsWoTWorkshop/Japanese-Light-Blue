...
This mod changes the color of the HD Japanese tanks from their default green to a light blue color, inspired by the "warship grey" color seen in the... "other" game.
...
To install:
- Drop the "CWW-RecolorPack-Japanese-Light-Blue" folder from inside the "MAIN MOD - COLOR CHANGE" folder into <Your WoT Directory\mods\<Game Version> (example: C:\Games\World_of_Tanks\mods\1.9.1.2).
